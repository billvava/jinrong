...
<a href="<?php echo U('Personal/invitee');?>"><i class="icon-nav-dot"></i>邀请注册</a>
	  	...
	  	<div class="mainbox">
			<!--职位切换卡 -->
			<div class="tab">
				<a class="li select">我的头像</a>
			  	<div class="clear"></div>
			</div>
			<!--切换卡结束 -->
			<div class="main">
		  		<div id="altContent" class="user_avatar">
					<OBJECT classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,40,0" WIDTH="650" HEIGHT="450" id="myMovieName">
						<PARAM NAME=movie VALUE="../public/flash/resumelogo.swf">
						<PARAM NAME=quality VALUE=high>
						<PARAM NAME=bgcolor VALUE=#FFFFFF>
						<param name="flashvars" value="imgUrl=../public/flash/photodefault.jpg&uploadUrl=<?php echo urlencode(U('home/upload/avatar'));?>&uploadSrc=false" />
						<EMBED src="../public/flash/resumelogo.swf" quality=high bgcolor=#FFFFFF WIDTH="650" HEIGHT="450" wmode="transparent" flashVars="imgUrl=<?php echo ($visitor['avatars']); ?>&uploadUrl=<?php echo urlencode(U('home/upload/avatar'));?>&uploadSrc=false" NAME="myMovieName" ALIGN="" TYPE="application/x-shockwave-flash" allowScriptAccess="always" PLUGINSPAGE="http://www.macromedia.com/go/getflashplayer"></EMBED>
					</OBJECT>
				</div>
