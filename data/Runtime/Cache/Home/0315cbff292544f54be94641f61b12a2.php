...
<div class="mainbox">
<div class="main">
<form id="afrm" method="post" action="<?php echo U('Personal/draft');?>" novalidate="novalidate">
<div class="perfect-information">
<div class="fn-clear ui-le-ht24"><i class="fn-left icoBul16 fn-mt-5"></i>
<div class="fn-ml-20">上传票据。</div>
</div>            
</div>
...
<section class="part-fieldset-text">
<span class="fn-pr fn-herit">
<input class="t_input prompt-pass-style" value="" type="file">
<span class="prompt_pass">请上传票据照片</span>
</span>
</section>
</article>
