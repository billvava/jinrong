...
<h2>邮箱认证</h2>
<p>
邮箱：<input type="text" name="email" placeholder="请输入邮箱" class="email" style="width:200px;height: 25px;" /> 请输入正确的邮箱，收到邮件后点击认证即可
</p>
<input type="hidden" class="id" value="<?php echo ($id); ?>">
<h3 class="submit">提交</h3>
</ul>
</div>
