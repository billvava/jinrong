...
<form action="/index.php/Home/UserCert/position" enctype="multipart/form-data" method="post" >

<div class="main_img">
<p class='anli' style="height: 25px;margin-top: 10px">个人职务证明：<input type='file'  name='id_card_img[]'></p>
</div>
