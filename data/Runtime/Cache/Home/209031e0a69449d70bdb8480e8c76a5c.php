...
<form action="/index.php/Home/UserCert/enterpriseIdCard" enctype="multipart/form-data" method="post" >
<p>企业名称：<input type='text'  name='company'></p>
<p>授权人姓名：<input type='text'  name='empower_name'></p>
<p>营业执照编号：<input type='text'  name='business_license_no'></p>
<p>企业授权书：<input type='file'  name='id_card_img[]'></p>
<p>营业执照：<input type='file'  name='id_card_img[]'></p>
