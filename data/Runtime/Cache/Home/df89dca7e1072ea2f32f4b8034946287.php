...
<link href="../public/css/personal/published.css" rel="stylesheet" type="text/css" />
<style type="text/css">
...
<div class="fn-clear ui-le-ht24"><i class="fn-left icoBul16 fn-mt-5"></i><div class="fn-ml-20 ui-text-gray-2">说明：<br>1、刷新：相当于新发一条信息，在按时间排序的情况下信息将靠前显示。每天可免费刷新一次。<br>2、审核中：审核中的信息除了您自己外，其他人无法看到，工作人员会在24小时内为您审核。</div></div>
</div>
<div>
<?php if(is_array($info_list)): foreach($info_list as $key=>$vo): ?><div class="part-info-a-all">
<header>
<span class="fn-left"></span>
<span class="fn-right">最后更新：<span><?php echo date('Y-m-d',$vo['updatetime']);?></span></span>
</header>
<div class="part-info-a-box">
<table width="100%">
<tbody><tr>
<td>
<p class="news-info-title">
<span class="news-info-name"><?php echo ($vo["title"]); ?></span>
</p>
<p class="fn-mt-5 fn-text-overflow w330"><?php echo ($vo["i_overview"]); ?></p>
<p><?php echo ($info_type[$vo['info_type']]); ?> <?php if($vo['info_type'] != 200): echo ($vo["amount_interval_min"]); if($vo["amount_interval_min_unit"] ==1): ?>万<?php else: ?>亿<?php endif; ?>～<?php echo ($vo["amount_interval_max"]); if($vo["amount_interval_max_unit"] ==1): ?>万<?php else: ?>亿<?php endif; endif; ?></p> 
</td>
<td width="160">
<p class="ui-text-black">
<?php if($vo["is_open"] == 2): ?>等待审核
<?php elseif($vo["is_open"] == 1): ?>
已发布
<?php else: ?>
审核未通过<?php endif; ?>
</p>
</td>
<td class="fn-pr" width="168">
<span class="ui-text-black fn-vam">完整度评分：</span>
<span class="info-guide-item-part">
<span class="vip-progress-small fn-mr-5 info-guide-title">
<i class="vip-progress-pillar-small" style="width: 89%"></i>
</span>
</span>
<span class="ui-text-red  fn-vam">89分</span>
<br>
还不错哦，再接再厉！
<div class="delivery-times-msg">
<div class="ui-dialog-arrow-a"></div>
<div class="ui-dialog-arrow-b"></div>
<div class="delivery-times-boxbg"></div>
<p>信息完整度:
<strong class="ui-text-red">89%</strong>, 高于全网<strong class="ui-text-red">13%</strong>, 再完善一下信息，就成抢手信息了！<br><a href="/Personal/edit/info_type/<?php echo ($vo["info_type"]); ?>/id/<?php echo ($vo["id"]); ?>">去完善信息</a>
</p>
</div>
</td>
<td data-id="#" title="<?php echo ($vo["title"]); ?>" width="88" align="right">
未委托<br>刷新</td>
</tr>
</tbody></table>
<footer class="fn-clear">
<span class="fn-left">
浏览：<?php echo ($vo["click"]); ?> 
留言：<a href="/Personal/receive" target="_blank" class="fn-font-b ui-text-red fn-mr-10"><?php echo ($vo["count"]); ?></a>
收藏：<a href="/Personal/manage_rss" target="_blank" class="fn-font-b ui-text-red fn-mr-10">0</a>
收到约谈：<a href="/Personal/talks" target="_blank" class="fn-font-b ui-text-red fn-mr-10">0</a>
</span>
<span class="fn-right"><a href="javascript:;" id="OP-592013" data-id="592013645c63eaaac157da41151da64a59b3c3" data-auth="0" class="T-permiss-set">权限设置</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/Personal/edit/info_type/<?php echo ($vo["info_type"]); ?>/id/<?php echo ($vo["id"]); ?>">修改</a>/<a href="javascript:;" data-id="<?php echo ($vo["id"]); ?>" class="T-hand-del">删除</a></span>
</footer>
</div>
...
<script src="../public/js/publish.js" type="text/javascript" language="javascript"></script>
<script>
    $('.fn-text-overflow').find('br').remove();
</script>
</body>
</html>