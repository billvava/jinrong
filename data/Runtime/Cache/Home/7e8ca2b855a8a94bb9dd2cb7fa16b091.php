...
<form action="/index.php/Home/UserCert/successfulCases" enctype="multipart/form-data" method="post" >

<div class="main_img">
<p class='anli' style="height: 25px;margin-top: 10px">成功案例：<input type='file'  name='id_card_img[]'></p>
</div>
<input type="hidden" name="id" value="<?php echo ($id); ?>" >
<input type="button" class="add" value="添加更多成功案例" >
...
$(function(){
   $('.add').on('click',function(){
      var htmladd="";
      htmladd +="<p class='anli' style='height: 25px;margin-top: 10px'>成功案例：<input type='file'  name='id_card_img[]'></p>";
      $(".main_img").append(htmladd);
    })
})
</script>
