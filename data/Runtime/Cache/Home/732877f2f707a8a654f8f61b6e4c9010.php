...
<a href="<?php echo U('Personal/invitee');?>"><i class="icon-nav-dot"></i>邀请注册</a>
  	  ...
  	  <div class="mainbox">
			...
			<div class="tab">
				...
				<a class="li J_hoverbut" href="<?php echo U('personal/user_safety');?>">账号安全</a>
				<a class="li select">登录日志</a>
			  	<div class="clear"></div>
			</div>
			<!--切换卡结束 -->
			<div class="log_th">
			...
			<?php if(is_array($loginlog['list'])): $i = 0; $__LIST__ = $loginlog['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$log): $mod = ($i % 2 );++$i;?><div class="log J_hoverbut">
