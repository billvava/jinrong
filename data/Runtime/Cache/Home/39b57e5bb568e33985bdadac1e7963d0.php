<?php if (!defined('THINK_PATH')) exit();?><div class="modify_user_dialog">
	...
	<div id="J_emailVerifyWrap" class="content">
		...
		<div class="td2">
			<input type="text" value="<?php echo ($members_info["email"]); ?>" class="input_245_34" name="email" placeholder="请输入您的常用邮箱">
		</div>
		<div class="clear"></div>
...
<script type="text/javascript">
    $('#J_emailVerifyCode').click(function(){
        ...
        $.post("<?php echo U('Members/send_email_varify_url');?>",{email:email},function(result){
            if(result.status == 1){
