...
<div class="mainbox">
<div class="main">
<?php if(!empty($userinfo['type'])): ?><div class="detection-data">
<div class="fn-clear">
<p class="fn-left"><strong>我的资料完整度评分：</strong><strong class="ui-text-red"><?php echo ($userinfo["percent_info"]["user_percent"]); ?> 分</strong></p>
</div>
<p class="fn-clear" style="display: none"><strong class="fn-left">未完善的资料：</strong>
<span class="ui-text-gray-2">
<?php if(is_array($userinfo['percent_info'][unperfect])): foreach($userinfo['percent_info'][unperfect] as $key=>$vo): echo ($category['account']['personal_explain'][$vo]); ?>&nbsp;,&nbsp;<?php endforeach; endif; ?>
</span>
</p>
</div><?php endif; ?>
...
<input name="type" id="type2" value="3" checked="" type="radio"><label for="type2">个人</label>
...
<section>
<span class="fn-pr fn-herit">
<textarea name="personal_introduce" class="prompt-pass-style"><?php echo ($userinfo['personal_introduce']); ?></textarea>
<span class="prompt_pass">个人信息+教育经历+工作经历+专业技能+自我评价等内容</span>
</span>
</section>
</article>
...
<input name="phone_cr" value="<?php echo ($userinfo['phone_cr']); ?>" class="t_input w20" maxlength="3" type="text"><span class="fn-mr-5">-</span>
...
<span class="prompt_pass" style="display: none;">请输入常用的QQ号码</span>
</span>
</section>
</article>
<article class="part-fieldset">
...
<span id="divAreaSelect"></span>
<input  type="hidden" id="last_area_id" name="last_area_id" value="<?php echo ($userinfo['last_area_id']); ?>" />
</section>
</article>
<article class="part-fieldset">
<aside></aside>
...
<span class="prompt_pass" style="display: none;">请输入详细街道地址</span>
</span>
</section>
</article>
</div>
