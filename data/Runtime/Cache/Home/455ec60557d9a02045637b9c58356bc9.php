...
<ul>
<li class="ui-tab-head-current"><a href="<?php echo U('BusinessCard/my');?>">我的商友</a></li>
...
<a href="<?php echo U('Home/Fund/fund_list');?>" class="fn-vam">您还没有和任何人成为商友，马上主动出击，向资金方交换名片。</a>
</div>
</ul>
