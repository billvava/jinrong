...
.news-info-hover .j-See-reply-con {
    display: block;
    margin-right: 60px;
}
...
<ul>
<li><a href="<?php echo U('BusinessCard/my');?>">我的商友</a></li>
<li><a href="<?php echo U('BusinessCard/myfollow');?>">已递送名片</a></li>
<li class="ui-tab-head-current">
<a href="<?php echo U('BusinessCard/myfans');?>">收到的名片</a>
</li>
<li><a href="<?php echo U('BusinessCard/contact');?>">已查看联系方式</a></li>
</ul>
</div>
</div>
...
<input name="act" value="myfans" type="hidden">
...
<?php if(is_array($business_card_list)): $i = 0; $__LIST__ = $business_card_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$business_card): $mod = ($i % 2 );++$i;?><li class="news-info-item">
<div class="user-avatar">
<a href="#" target="_blank">
<?php if($business_card["sex"] == 0): ?><img src="../public/images/face/nan1.gif">
<?php else: ?>
<img src="../public/images/face/nv1.gif"><?php endif; ?>
</a>
</div>
<div class="news-info-wrap">
<p class="news-info-title">
<span class="news-info-name">
<a href="#" target="_blank"><?php echo ($business_card['realname']); ?></a>
</span>
<i class="icon-auth-p-16-1 fn-mr-5" title="项目"></i>
<i class="icon-auth-s-16-3 fn-mr-5" title="个人"></i></p>
<?php if($business_card["company_name"] != ''): if($business_card["job"] != ''): ?><p class="news-info-post">公司: <?php echo ($business_card['company_name']); ?> &nbsp;&nbsp; 职位: <?php echo ($business_card['job']); ?></p>
<?php else: ?>
<p class="news-info-post">公司: <?php echo ($business_card['company_name']); ?></p><?php endif; ?>
<?php else: ?>
<?php if($business_card["job"] != ''): ?><p class="news-info-post"> 职位: <?php echo ($business_card['job']); ?></p><?php endif; endif; ?>
<p class="news-info-industry">
<span class="news-info-industry-cont">所属行业: <?php echo ($business_card['industry_id']); ?>
</span>
<span class="news-info-control" data-id="<?php echo ($business_card['uid']); ?>">
<a href="javascript:;" event="click.exchange" class="ui-btn-small ui-btn-blue">加为商友</a>
</span>
</p>
<p class="news-info-trends">
<span class="news-info-time"><?php echo ($business_card['addtime']); ?> 申请交换名片</span>
<span class="news-info-relation">人脉关系：<a href="#" target="_blank">已递送名片(<strong><?php echo ($business_card['business_count']); ?></strong>)</a> | <a href="#" target="_blank">商友(<strong>3</strong>)</a></span></p>
</div>
