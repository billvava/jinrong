...
<a href="/zt/release.html" class="fn-right ui-btn-small ui-btn-blue" target="_blank">发布信息指南</a>
...
<input type="hidden" name="info_type" value="700"/>
...
<label><input onclick='location.href="<?php echo U('Personal/zjxm_publish',array('add'=>700));?>"' checked="" value="700" type="radio"> 政府招商</label>
<label>
...
<dt><i>*</i>信息标题：</dt>
<dd>
<input name="title" id="title" class="text wb70" value="<?php echo ($info["title"]); ?>" data-rule="required|min_length[8]|max_length[30]" maxlength="30" min_length_err="请填写标题，8-30个汉字内" max_length_err="请填写标题，8-30个汉字内" holder="举例：湖北襄阳某高新技术开发区政府招商；广东某开发区食品生产项目政府招商" type="text"> <em class="pl5 hide" etype="error_info">
<i class="icoPro16"></i>
请填写信息标题</em>
<div style="color:#dc5c5c">标准：地区+招商行业+开发区/区域+项目+政府招商</div></dd>
</dl>

<dl>
<dt><i>*</i>所在地区：</dt>
<dd>
<span id="last_area_iddivAreaSelect">
</span>
<input class="hidea" id="last_area_id" name="last_area_id" value="" data-rule="required" btype="change" type="text">
...
<?php if(is_array($category_list['industry_id'])): foreach($category_list['industry_id'] as $key=>$vo): ?><option value="<?php echo ($vo["c_id"]); ?>" <?php if($info['industry_id'] == $vo['c_id']): ?>selected="selected"<?php endif; ?>><?php echo ($vo["c_name"]); ?></option><?php endforeach; endif; ?>
</select>
<em class="hide" etype="error_info" id="industry_id_info">
<i class="icoPro16"></i>请选择招商行业</em>
</dd>
</dl>
...
<dt>投资估算：</dt>
<dd>
<input name="amount_interval_min" id="amount_interval_min" maxlength="10" class="text w80 mr5" value="<?php echo ($info["amount_interval_min"]); ?>" data-rule="regexp[num]|greater[0]|greater[min_max]|max_length[18]" data-name="amount_interval" data-merge="amount_interval_max,amount_interval_min" type="text">
...
-- 
<input name="amount_interval_max" id="amount_interval_max" maxlength="10" class="text w80 ml5 mr10" value="<?php echo ($info["amount_interval_max"]); ?>" data-rule="regexp[num]|greater[0]|greater[min_max]|max_length[18]" data-name="amount_interval" iname="投资估算" data-merge="amount_interval_max,amount_interval_min" type="text">
...
<dt>招商方式：</dt>
<dd>
<?php if(is_array($category_list['xmf_zs_way'])): foreach($category_list['xmf_zs_way'] as $key=>$vo): ?><label for="xmf_zs_way_<?php echo ($vo["c_id"]); ?>">
<input name="xmf_zs_way[]" id="xmf_zs_way_<?php echo ($vo["c_id"]); ?>" value="<?php echo ($vo["c_id"]); ?>" class="checkbox" <?php if($vo["ext_form_id"] != ''): ?>extra="1" extra_id="<?php echo ($vo["ext_form_id"]); ?>"<?php endif; ?> <?php if($vo["data_rule"] == 1): ?>data-rule=""<?php endif; ?> type="checkbox">
<?php echo ($vo["c_name"]); ?></label><?php endforeach; endif; ?>
<input id="extra_xmf_zs_way-671" name="extra_xmf_zs_way[671]" style="display:none;" value="<?php echo ($info["extra_xmf_zs_way"]); ?>" type="text">
<em class="hide" etype="error_info">
<i class="icoPro16"></i>
请选择或填写招商方式</em>
<?php if($info["xmf_zs_way"] != ''): ?><script>
$(function(){
var val = '<?php echo ($info["xmf_zs_way"]); ?>';
$('input[name="xmf_zs_way\[\]"]').each(function(){
...
<i class="icoPro16"></i>
请填写项目内容</em>
<div style="color:#dc5c5c">项目介绍+招商需求+详细用途</div></dd>
</dl>

<dl>
<dt>投资环境：</dt>
<dd>
<textarea name="S86" rows="6" class="wb70" id="S86" data-rule="max_length[5000]" maxlength="5000"><?php echo ($info["s86"]); ?></textarea>
<em class="hide" etype="error_info"><i class="icoPro16"></i>请填写投资环境</em>
</dd>
</dl>
...
<dt>项目背景：</dt>
<dd>
<textarea name="S87" rows="6" class="wb70" id="S87" data-rule="max_length[5000]" maxlength="5000"><?php echo ($info["s87"]); ?></textarea>
<em class="hide" etype="error_info">
<i class="icoPro16"></i>请填写项目背景</em>
</dd>
</dl>
...
<dt>项目规模：</dt>
<dd>
<textarea name="S88" rows="6" class="wb70" id="S88" data-rule="max_length[5000]" maxlength="5000"><?php echo ($info["s88"]); ?></textarea>
<em class="hide" etype="error_info">
<i class="icoPro16"></i>请填写项目规模</em>
</dd>
</dl>
...
<dt>效益预算：</dt>
<dd>
<textarea name="S89" rows="6" class="wb70" id="S89" data-rule="max_length[5000]" maxlength="5000"><?php echo ($info["s89"]); ?></textarea>
<em class="hide" etype="error_info">
<i class="icoPro16"></i>请填写效益预算</em>
</dd>
</dl>
...
<dt>优惠政策：</dt>
<dd>
<textarea name="S90" rows="6" class="wb70" id="S90" data-rule="max_length[5000]" maxlength="5000"><?php echo ($info["s90"]); ?></textarea>
<em class="hide" etype="error_info">
<i class="icoPro16"></i>请填写优惠政策</em>
</dd>
</dl>
...
<i class="icoPro16"></i>请填写关键词多个以“，”隔开</em>
</dd>
</dl>
