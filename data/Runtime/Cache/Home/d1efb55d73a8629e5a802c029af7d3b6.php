    ...
    <div class="container">
        <div class="choose">
            <div class="result clearfix <?php if(select_condition()): else: ?>display-none<?php endif; ?>">
                ...
                <?php if($_GET['tzlc_type']!= ''): ?><a choose="tzlc_type" href="window.location='<?php echo P(array('key'=>''));?>';"><?php echo ($category['tzlc_type'][$_GET['tzlc_type']]); ?><i class="iconfont icon-error"></i></a><?php endif; ?>
            ...
            <div class="tzlc_type">
                <span>产品类型：</span>
                <p choose="tzlc_type">
                    <a <?php if($_GET['tzlc_type']== ''): ?>class="select"<?php endif; ?> href="<?php echo P(array('tzlc_type'=>''));?>">不限</a>
                    <?php if(is_array($category['tzlc_type'])): $k = 0; $__LIST__ = $category['tzlc_type'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><a <?php if($_GET['tzlc_type']== $key): ?>class="select"<?php endif; ?> href="<?php echo P(array('tzlc_type'=>$key));?>"><?php echo ($vo); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
                </p>
            ...
            <ul>
                <?php if(!empty($info_list)): if(is_array($info_list)): $i = 0; $__LIST__ = $info_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                    ...
                    <div class="message">
                        ...
                        <span><i class="iconfont icon-suoshuhangye"></i>所属行业：<?php echo ($vo["industry_id"]); ?></span>
                        <span><i class="iconfont icon-rongzi"></i>项目融资方式：<?php echo ($vo["xmrz_type"]); ?></span>
                    </div>
