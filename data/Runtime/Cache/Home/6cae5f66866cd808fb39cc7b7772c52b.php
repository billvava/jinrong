...
<form action="/index.php/Home/UserCert/honor" enctype="multipart/form-data" method="post" >

<div class="main_img">
<p class='anli' style="height: 25px;margin-top: 10px">企业荣誉：<input type='file'  name='id_card_img[]'></p>
</div>
<input type="hidden" name="id" value="<?php echo ($id); ?>" >
<input type="button" class="add" value="添加更多企业荣誉" >
