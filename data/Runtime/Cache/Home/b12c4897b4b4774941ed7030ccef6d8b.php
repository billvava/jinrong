...
<input name="type" id="type3" value="2" checked="" type="radio"><label for="type3">政府</label>
</em>
...
<h2>政府资料<i class="icoDot"></i></h2>
<div class="fieldsetBd">
<article class="part-fieldset">
<aside><span class="ui-text-red font-simsun">*</span>单位名称：</aside>
...
<span class="prompt_pass">请输入单位简介</span>
</span>
...
<select name="last_fiscal_revenue" id="last_fiscal_revenue" class="select-w126">
<option value="">请选择</option>
<?php if(is_array($category['last_fiscal_revenue'])): $i = 0; $__LIST__ = $category['last_fiscal_revenue'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if($userinfo["last_fiscal_revenue"] == $key): ?>selected=""<?php endif; ?>><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
</select>
</span>
</span>
</section>
...
<aside>单位地址：</aside>
<section class="part-fieldset-section">
<span id="divAreaSelectCompany"></span>
...
<aside></aside>
<section>
<input name="company_address" value="<?php echo ($userinfo["company_address"]); ?>" class="t_input" placeholder="请输入详细街道地址。" type="text">
</section>
</article>
...
<?php if(is_array($category['contact_job']['government'])): $i = 0; $__LIST__ = $category['contact_job']['government'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if($userinfo["contact_job"] == $key): ?>selected=""<?php endif; ?>><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
</select>
</span>
</span>
<input name="contact_job_name" id="contact_job_name" value="<?php echo ($userinfo["contact_job_name"]); ?>" maxlength="6" class="text w160 fn-hide t_input ac_input" style="display: none;" autocomplete="off" type="text">
</section>
</article>
<article class="part-fieldset">
<aside>所在部门：</aside>
...
<aside>电话号码：</aside>
<section class="part-fieldset-section">
<input name="phone_cr" value="<?php if(empty($phone_cr)): ?>086<?php else: echo ($userinfo["phone_cr"]); endif; ?>" class="t_input w20" maxlength="3" type="text"><span class="fn-mr-5">-</span>
