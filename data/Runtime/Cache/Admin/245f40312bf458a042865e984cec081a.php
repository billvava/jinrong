...
<script>
	var URL = '/index.php/Admin/Explain',
		SELF = '/index.php?m=Admin&amp;c=Explain&amp;a=index',
...
<body style="background-color:#E0F0FE">
    ...
    <form id="form1" name="form1" method="post" action="<?php echo U('explain/delete');?>">
      <table width="100%" border="0" cellpadding="0" cellspacing="0" id="list" class="link_lan">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
              <td  class="admin_list admin_list_first">
                ...
                <a href="<?php echo url_rewrite('QS_explainshow',array('id'=>$list['id']));?>" style="<?php if($list['tit_color']): ?>color:<?php echo ($list["tit_color"]); ?>;<?php endif; if($list['tit_b'] > 0): ?>font-weight:bold<?php endif; ?>" target="_blank" ><?php echo ($list["title"]); ?></a>
                <?php echo ($list["url_title"]); ?>
              ...
              <td  align="center"  class="admin_list"><a href="<?php echo U('explain/edit',array('id'=>$list['id']));?>">修改</a> <a href="<?php echo U('explain/delete',array('id'=>$list['id']));?>" onclick="return confirm('你确定要删除吗？')">删除</a></td>
    ...
    <table width="100%" border="0" cellspacing="10" cellpadding="0" class="admin_list_btm">
      <tr>
        <td>
            <input type="button" class="admin_submit" id="ButAudit" value="添加说明页"  onclick="window.location='<?php echo U('explain/add');?>'"/>
