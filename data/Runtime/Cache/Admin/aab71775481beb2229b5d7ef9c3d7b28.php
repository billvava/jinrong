...
<script>
	var URL = '/index.php/Admin/Statistics',
		SELF = '/index.php?m=Admin&amp;c=Statistics&amp;a=index',
...
<script type="text/javascript" src="__ADMINPUBLIC__/js/jquery.min.js"></script>
<script type="text/javascript" src="__ADMINPUBLIC__/js/Highcharts-5.0.12/code/highcharts.js"></script>
<div class="toptit">系统信息</div>
<div id="container" style="width: 100%; height: 400px; margin: 0 auto"></div>
<script>
$(function () {
    $('#container').highcharts(<?php echo ($jsonArray); ?>);
});
</script>
</div>
