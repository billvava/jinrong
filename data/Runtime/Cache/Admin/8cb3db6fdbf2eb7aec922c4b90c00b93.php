...
<body>
	<div class="admin_top_bg">
		<table width="1400" height="70" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td width="200" rowspan="2" align="right" valign="middle" ><div align="center"><img src="__ADMINPUBLIC__/images/logo_in.png" /></div>
				</td>
				<td height="39" align="right" valign="middle" class="link_w">
					欢迎<?php echo ($admin_rank); ?>：<strong><a style="color: #99FF00;" href="<?php echo U('Admin/admin/edit',array('id'=>$visitor['id']));?>" target="mainFrame"><?php echo ($visitor["realname"]); ?></a></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo U('index/logout');?>" target="_top">[退出]</a>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; <a href="<?php echo C('qscms_site_domain'); echo C('qscms_site_dir');?>" target="_blank">网站首页</a>&nbsp;&nbsp;&nbsp;&nbsp;
				</td>
			</tr>
			<tr>
