...
<script>
	var URL = '/index.php/Admin/Crm',
		SELF = '/index.php?m=Admin&amp;c=Crm&amp;a=index',
...
<form id="form1" name="form1" enctype="multipart/form-data" method="post" action="<?php echo U('throw_into_sea');?>">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="link_lan">
    <tr>
      ...
      <?php if(is_array($member_list)): $i = 0; $__LIST__ = $member_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
        ...
        <input name="uid[]" type="checkbox" id="uid" value="<?php echo ($vo['uid']); ?>"/>
          <?php echo ($vo['uid']); ?>
          </td>
        ...
        <td align="center" class="admin_list">
         ...
         <td align="center" class="admin_list"><?php if(vo['is_locked'] == 1): ?><span style="color:#f00;"><?php echo ($vo["is_locked"]); ?></span><?php else: echo ($vo["is_locked"]); endif; ?>
          ...
          <td align="center"  class="admin_list">
            <a class="custormer_info"  parameter="uid=<?php echo ($vo['uid']); ?>" href="javascript:void(0);" hideFocus="true">管理</a>
          </td>
    ...
    <table width="100%" border="0" cellspacing="10" cellpadding="0" class="admin_list_btm">
      <tr>
        <td>
          <input type="button" class="admin_submit" id="ButAudit" value="踢进公海" />
          <!--
  ...
  <div id="AuditSet" style="display: none" >
    <table width="400" border="0" align="center" cellpadding="0" cellspacing="6" >
      <tr>
        <td height="30">&nbsp;</td>
        <td height="30"><strong  style="color:#0066CC; font-size:14px;">将所选客户踢进公海：</strong></td>
      </tr>
      <tr>
