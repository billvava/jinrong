	...
	return function(a, b) {
		...
		c.fn.init = function() {
			...
			f.css({
				width: d,
				height: e ? e : "auto"
			}), f.append(g), f.append(c), a.$panel = f, a.$triangle = g
		}, c.fn.initHideEvent = function() {
			var c = this,
				d = c.$panel.get(0);
			a.$body.on("click", function(a) {
			...
			if (c(e)) {
				...
				i.isShowCode = !1, i.clickEvent = function(a) {
					...
					k.css({
						height: j,
						"margin-top": h - j
					}), k.val(g.html()), k.on("change", function(a) {
						d()
				...
				l.clickEvent = function(a) {
					...
					if (e && e.listLanguages) {
						...
						o.css({
							"margin-top": "9px",
							"margin-left": "5px"
						}), b.each(e.listLanguages(), function(a, b) {
		...
		a.plugin(function() {
			...
			c.onload || (c.onload = function(b, c) {
				...
				0 == b.code ? (a.warn("上传失败：" + b.msg), alert(b.msg)) : (a.log("上传成功，即将插入编辑区域，结果为：" + b.url), d = document.createElement("img"), d.onload = function() {
					var c = '<img src="' + b.url + '" alt="' + f + '" style="max-width:100%;"/>';
					e.command(null, "insertHtml", c), a.log("已插入图片，地址 " + b.url), d = null
				}, d.onerror = function() {
