...
class BaseController extends Controller{
    ...
    protected function _initialize() {
        ...
        if(false === $category = F('category')){
            $category = D('Category')->category_cache();
        }
        if(false === $area = F('area')){
            D('Area')->build_cache();
        }
        if(false === $category_list = F('category_list')){
            $category_list = D('Category')->category_list();
        }
     ...
     * 上传文件
     */
    protected function _upload($file, $dir = '', $thumb = array(), $save_rule='uniqid',$type='') {
