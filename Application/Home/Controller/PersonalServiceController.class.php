...
class PersonalServiceController extends PersonalController{
    ...
    */
    ...
    public function increment_add($cat=''){
        ...
        switch($cat){
            case 'stick':
                $this->assign('choose_arr',M('PersonalServiceStick')->select());
            ...
            case 'tag':
                $this->assign('tag_arr',M('PersonalServiceTagCategory')->select());
                $this->assign('choose_arr',M('PersonalServiceTag')->select());
            ...
            case 'tpl':
                $choose_arr = M('Tpl')->where('tpl_type=2')->select();
