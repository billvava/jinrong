   ...
   module.exports = {
        ...
        dialog_have_callback:function(msg,title,btn_text,callback){
            window.dlo = dialog({
                title: title || "温馨提示",
                lock:true,
                fixed:true,
                width:'480px',
                content:' <div class="popup-msg-a fn-tac"><p class="part-popup-ittext">'+msg+'</p><footer class="fn-mt-30"><a href="javascript:;" id="J_dialog_btn_action"  class="ui-btn ui-btn-red">'+btn_text+'</a></footer></div>',
                okValue: '确定',
                cancelValue: '取消',
                close: function(){
                    dl = null;
